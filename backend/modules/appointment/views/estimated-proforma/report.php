        ...
        <div style="">
            <table>
                <tr>
                    ...
                    <td style="width: 250px;"></td>
                    <td style="width: 250px;"><b>Date:</b><?= date("d/m/Y") ?></td>
                </tr>
                <tr>
                    <td style="width: 250px;"></td>
                    <td style="width: 250px;"></td>
                ...
                <tr><td colspan="4"></td></tr>
                <tr>
                    <td style="width: 250px;"><b>Port:</b><?= $appointment->portOfCall->port_name ?></td>
                    <td style="width: 250px;"><b>Vessel:</b><?= $appointment->vessel0->vessel_name ?></td>
                    <td style="width: 250px;"></td>
                ...
                <tr><td colspan="4"></td></tr>
                <tr>
                    <td style="width: 250px;"><b>ETA:</b><?= $appointment->eta ?></td>
                    <td style="width: 250px;"><b>Purpose:</b><?= $appointment->purpose0->purpose ?></td>
                    <td style="width: 250px;"></td>
                    ...
                    if (!empty($subcategories)) {
                            ...
                            <table width="1000" class="table">
                                ...
                                foreach ($subcategories as $subcategory) {
                                        ?>
                                        <tr>
                                            <td><?= $subcategory->sub_service ?>
                                            </td>
                                            <td><?= $subcategory->rate_to_category ?>
                                            </td>
                                            <td><?= $subcategory->unit ?>
                                            </td>
                                            <td><?= $subcategory->comments ?>
                                            </td>
                                            <td><?= $subcategory->unit_price ?>
                                            </td>
                                            <td><?= $subcategory->total ?>
                                            </td>
                                            <?php
